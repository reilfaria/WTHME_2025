...
<div style="max-width:1000px; margin:0 auto;">
    ...
    <div style="background:white; border-radius:1rem; padding:3rem; text-align:center; border:2px solid #bdd1d3;">
        ...
        <p style="color:#002f45; opacity:0.5;">Belum ada data absensi peserta.</p>
    </div>
    @else
    ...
    <div style="background:white; border-radius:1rem; overflow:hidden; border:1px solid #bdd1d3; margin-bottom:1.5rem;">
        <div style="background:#002f45; padding:0.875rem 1.25rem; display:flex; justify-content:space-between; align-items:center;">
            <span style="color:#d2c296; font-weight:700;">Kelompok {{ $kelompok }}</span>
            <span style="color:#bdd1d3; font-size:0.8rem;">{{ $dataKelompok->count() }} orang hadir</span>
        </div>
        <table style="width:100%; border-collapse:collapse;">
            <thead>
                <tr style="background:#f9f8f6;">
                    ...
                    <th style="padding:0.75rem 1rem; text-align:left; color:#002f45; font-size:0.75rem; font-weight:600; text-transform:uppercase; letter-spacing:0.05em; opacity:0.6;">Angkatan</th>
            ...
            <tbody>
                ...
                <tr style="border-top:1px solid #e0decd;">
                    ...
                    <td style="padding:0.75rem 1rem; color:#002f45; font-size:0.875rem; opacity:0.7;">{{ $absen->angkatan }}</td>
