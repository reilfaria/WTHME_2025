...
use App\Http\Controllers\KesehatanController; // Tambahkan ini di baris atas bersama use lainnya
// Tambahkan baris ini di bagian atas routes/web.php
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('panitia')->name('panitia.')->middleware('panitia')->group(function () {
        ...
        // Route::get('/panitia/notulensi/{id}/download', [NotulensiController::class, 'downloadDoc'])->name('panitia.notulensi.download');
        // Tambahkan baris ini!
        Route::get('/panitia/notulensi/{id}/download', [App\Http\Controllers\NotulensiController::class, 'downloadDoc'])->name('notulensi.download');   
